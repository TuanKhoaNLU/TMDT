...
export const marketplaceApi = {
  ...
  askQuestion: (productId, payload) =>
    axiosInstance.post(`/products/${productId}/questions`, payload).then((res) => res.data),
  answerQuestion: (questionId, payload) =>
    axiosInstance.post(`/seller/questions/${questionId}/answer`, payload).then((res) => res.data),
  addReview: (productId, payload) =>
    axiosInstance.post(`/products/${productId}/reviews`, payload).then((res) => res.data),
  ...
  sendMessage: (conversationId, payload) =>
    axiosInstance.post(`/chat/conversations/${conversationId}/messages`, payload).then((res) => res.data),
  sendCustomQuote: (conversationId, payload) =>
    axiosInstance.post(`/chat/conversations/${conversationId}/custom-quotes`, payload).then((res) => res.data),
  customOrders: () => axiosInstance.get("/custom-orders").then((res) => res.data),
  updateCustomOrderStatus: (customOrderId, payload) =>
    axiosInstance.put(`/custom-orders/${customOrderId}/status`, payload).then((res) => res.data),
  ...
  acceptProposal: (postId, proposalId) =>
    axiosInstance.put(`/commissions/${postId}/proposals/${proposalId}/accept`).then((res) => res.data),
  ...
  verifySeller: (userId, verified = true) =>
    axiosInstance.put(`/admin/users/${userId}/verify-seller`, null, { params: { verified } }).then((res) => res.data),
